<?php
  ...
  // Implementamos un metodo para obtener todas las propiedades usando ActiveRecord
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST') {
    $id = $_POST['id'];                               // lo hago aca, porque si no pregunto si es un post, me marcaria undefined
