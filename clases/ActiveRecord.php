...
class ActiveRecord {
    ...
    public function eliminar() {
      $query = "DELETE FROM " . static::$tabla . " WHERE id = " . self::$db->escape_string($this->id) . " LIMIT 1"; //uso escape_string porque ese id viene de la url y alguien lo puede modificar !!!
    ...
    public static function all() {
      $query = "SELECT * FROM " . static::$tabla;   // la consulta devuelve un arreglo (Si usara self::$tabla tomaria el valor de tabla de activerecord)
                                                  // al usar static::$tabla toma el valor de la clase que heredo e hizo el llamado
    ...
    protected static function crearObjeto($registro) {          // este codigo crea un objeto en memoria en base a los resultados de la bd
      $objeto = new static;                                      // esto significa crear un nuevo objeto (con self ->en la clase actual) con static en la clase que heredo...
